...
void printMenu(void)
{
    ...
    printf("rm <n>          -- remove node <n> from local system\n");
    printf("tack <n>        -- attach a new node onto an existing node\n");
    ...
    printf("net             -- display the current blockchain of transactions\n");
